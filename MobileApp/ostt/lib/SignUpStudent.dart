...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<void> insertRecord() async {
    try {
      String uri = "https://osttnetrides.000webhostapp.com/insert_record_student.php";
                    ...
                    child: Column(
                      children: <Widget>[
                        TextFormField(
                          ...
                          onChanged: (value) {
                            _userName = value; // Assign the value directly
                          },
                        ),
                        ...
                        TextFormField(
                          ...
                          onChanged: (value) {
                            _email = value; // Assign the value directly
                          },
                        ),
                        SizedBox(height: 20.0),
                        TextFormField(
                          ...
                          onChanged: (value) {
                            _contact = value; // Assign the value directly
                          },
                        ),
                        SizedBox(height: 20.0),
                        TextFormField(
                          ...
                          onChanged: (value) {
                            _password = value; // Assign the value directly
                          },
                        ),
                        SizedBox(height: 20.0),
                        ElevatedButton(
