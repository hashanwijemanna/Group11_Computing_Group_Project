...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<void> insertRecord() async {
    try {
      String uri = "https://osttnetrides.000webhostapp.com/insert_record_parent.php";
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return "Please enter your child's password";
                            }
                            return null;
                          },
                          onChanged: (value) {
                        ...
                        ElevatedButton(
                          onPressed: () {
                            if (_formKey.currentState != null &&
                              ...
                              print('Student Email: $_stemail');
                              print('Student Password: $_stpassword');
                              insertRecord();
                            }
                          },
                          style: ButtonStyle(
